<?php 
/**
 * Template Name: Serivce Template
 *
 * Description: A page template that provides custom views for services for meednetworks
 *Training Site
        ...
        <div class="page-header-section">
            <div class="toolbar">
                <ol class="breadcrumb breadcrumb-transparent nm">
                    ...
                    <li><a href="#about"data-nav>Services</a></li>
